      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-border/60 bg-background px-6 py-3 text-sm font-semibold transition-all hover:bg-muted active:scale-95"
          >
