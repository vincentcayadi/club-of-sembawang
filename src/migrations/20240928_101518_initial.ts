...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE INDEX IF NOT EXISTS "header_items_order_idx" ON "header_items" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "header_items_parent_id_idx" ON "header_items" USING btree ("_parent_id");`)
}
